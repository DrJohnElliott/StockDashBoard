...
app.layout = dbc.Container([
    dbc.Row([
      dbc.Col(html.H4("Perf. of stocks from the date of ref.", 
    ...
    dbc.Row([
        dbc.Col([dcc.Graph(id="fig1_line", className="shadow-2g",figure={}, style={"pading":10,"border":"none"})
                
                ],#width ={'size':12}
                xs=12, sm=12, md=12, lg=5, xl=5
               ),
    
        dbc.Col([dcc.Graph(id="fig_hist", className="shadow-2g",figure={}, style={"pading":10,"border":"none"})
    ...
    dbc.Row([
        ...
        dbc.Col([dcc.Graph(id="fig2_line", className="shadow-2g",figure={}, style={"pading":10,"border":"none"})
                
                ],#width ={'size':12}
                xs=12, sm=12, md=12, lg=5, xl=5
               ),
            
        dbc.Col([dcc.Graph(id="fig_bar", className="shadow-2g",figure={}, style={"pading":10,"border":"none"})
